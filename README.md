...
This project is a translation of the [php-activerecord](https://github.com/kla/php-activerecord) project into a C extension for PHP. It is 
...
optimized C code. The project is based on the [php-activerecord](https://github.com/kla/php-activerecord) project; which is, in turn, based on 
